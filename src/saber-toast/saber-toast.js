// source: https://www.cssscript.com/stylish-toast-saber/
...
class SaberToast {
    ...
    loading(params) {
        this.color = "#5953FF"
        this.icon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="198" height="198" style="shape-rendering: auto; display: block; background: rgba(255, 255, 255, 0);" xmlns:xlink="http://www.w3.org/1999/xlink"><g><circle stroke-dasharray="164.93361431346415 56.97787143782138" r="35" stroke-width="15" stroke="#ffffff" fill="none" cy="50" cx="50">
    ...
    fire(params) {
        ...
        div.innerHTML = `
            ...
            <div class="close-icon-holder">
                <span class="${duration !== 0 ? `close-icon` : 'close-toast'}">
        ...
        duration !== 0
            ? div.querySelector(".close-icon").addEventListener("click", handleCloseBtn)
            : div.querySelector(".close-toast").addEventListener("click", handleCloseBtn)
    }
}
